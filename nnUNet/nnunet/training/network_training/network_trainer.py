...
class NetworkTrainer(object):
    def __init__(self, deterministic=True, fp16=False):
        ...
        # !   change for mc dropout 2021/10/07
        self.save_snapshots = True # whether or not to save the snapshot models after 500 epochs.
    ...
    def manage_patience(self):
        ...
        if self.patience is not None:
            ...
            if (self.epoch + 1)> 500 and (self.epoch + 1) % self.save_every == 0:
