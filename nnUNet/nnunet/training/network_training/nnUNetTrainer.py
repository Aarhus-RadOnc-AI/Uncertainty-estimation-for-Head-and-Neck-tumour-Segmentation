...
class nnUNetTrainer(NetworkTrainer):
    ...
    def predict_preprocessed_data_return_seg_and_softmax(self, data: np.ndarray, do_mirroring: bool = True,
                                                         ...
                                                         enable_dropout: bool = False) -> Tuple[np.ndarray, np.ndarray]:
        # ! add parm enable_dropout: bool = False
        """
        :param data:
        :param do_mirroring:
        :param mirror_axes:
        ...
        # ! add argument to check if dropout = True for "self.network.train()" / validation with train=True    
        if not enable_dropout:
            print("prediction for dropout!!")
            self.network.eval()
    ...
    def predict_preprocessed_data_return_seg_and_softmax_dropout(self, data: np.ndarray, do_mirroring: bool = True,
        ...
        if not enable_dropout:
            ...
            print("predict with dropout enabled !!")
