...
# # external
# ##PHISEG
# python ../src/false_target_detect.py -gt $TASK2_RAW -seg $PH_PMAP/f01234_tta/
# python ../src/false_target_detect.py -gt $TASK2_RAW -seg $PH_PMAP/f0_tta/

# python ../src/false_target_detect.py -gt $TASK2_RAW -seg $PH_GAMM_PMAP/f01234_tta/
# python ../src/false_target_detect.py -gt $TASK2_RAW -seg $PH_GAMM_PMAP/f0_tta/

# #nnunet
# python ../src/false_target_detect.py -gt $TASK2_RAW -seg $NNUNET_PMAPS/f01234_tta
# python ../src/false_target_detect.py -gt $TASK2_RAW -seg $NNUNET_PMAPS/f0_tta
# python ../src/false_target_detect.py -gt $TASK2_RAW -seg $NNUNET_PMAPS/f0
						
# # #dropout 0.2                  

# python ../src/false_target_detect.py -gt $TASK2_RAW -seg $DROP2_PMAPS/f0_mc10_tta

# python ../src/false_target_detect.py -gt $TASK2_RAW -seg $DROP2_PMAPS/f0_tta_snap
# python ../src/false_target_detect.py -gt $TASK2_RAW -seg $DROP2_PMAPS/f01234_mc10_tta_snap
