...
class nnUNetTrainerV2_UNETR(nnUNetTrainer):
    """
    ...
    def initialize_network(self):
        ...
        self.network = UNETR(input_channels=self.num_input_channels, num_classes=self.num_classes, patch_size=self.patch_size, deep_supervision=True)
