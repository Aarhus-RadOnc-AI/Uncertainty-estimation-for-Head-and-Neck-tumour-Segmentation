...
class NetworkTrainer(object):
    def __init__(self, deterministic=True, fp16=False):
        ...
        self.batch_val_eval_metrics = []  # does not have to be used
        self.epoch = 0
        self.log_file = None
        ...
        # !   change for snapshot and mc dropout 2021/10/07
        self.save_snapshots = False # whether or not to save the snapshot models after 500 epochs.
    ...
    def run_training(self):
        ...
        # !    change for mc dropout and save snapshots 2021/10/07
        print("Save snapshot models(save_snapshots) is set to: ", self.save_snapshots)
        ...
        while self.epoch < self.max_num_epochs:
            ...
            with torch.no_grad():
                ...
                if self.also_val_in_tr_mode:
                    self.network.train()
                    print("# validation with train=True")
    ...
    def manage_patience(self):
        ...
        if self.patience is not None:
            ...
            if (self.epoch + 1)> 900 and (self.epoch + 1) % self.save_every == 0:
                if self.save_snapshots: self.save_checkpoint(join(self.output_folder, "model_epoch_%d.model" %(self.epoch + 1)))
