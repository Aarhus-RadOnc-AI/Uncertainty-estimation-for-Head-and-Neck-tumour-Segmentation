...
def predict_cases(model, list_of_lists, output_filenames, folds, save_npz, num_threads_preprocessing,
                  num_threads_nifti_save, segs_from_prev_stage=None, do_tta=True, do_gaussian_noise=False, mixed_precision=True,
    ...
    for preprocessed in preprocessing:
        ...
        softmax = trainer.predict_preprocessed_data_return_seg_and_softmax(
            d, do_mirroring=do_tta, mirror_axes=trainer.data_aug_params['mirror_axes'],do_gaussian_noise=do_gaussian_noise, use_sliding_window=True,
    ...
    for preprocessed in preprocessing:
        ...
        for i, p in enumerate(params):
            ...
            res = trainer.predict_preprocessed_data_return_seg_and_softmax(d, do_mirroring=do_tta,
                                                                           ...
                                                                           do_gaussian_noise=do_gaussian_noise,
...
def predict_from_folder(model: str, input_folder: str, output_folder: str, folds: Union[Tuple[int], List[int]],
                        ...
                        part_id: int, num_parts: int, tta: bool,do_gaussian_noise: bool = False,  mixed_precision: bool = True,
    ...
    if mode == "normal":
        ...
        return predict_cases(model, list_of_lists[part_id::num_parts], output_files[part_id::num_parts], folds,
                             ...
                             do_gaussian_noise, mixed_precision=mixed_precision, overwrite_existing=overwrite_existing,
                             all_in_gpu=all_in_gpu,
        ...
        return predict_cases_fast(model, list_of_lists[part_id::num_parts], output_files[part_id::num_parts], folds,
                                  ...
                                  tta, do_gaussian_noise, mixed_precision=mixed_precision, overwrite_existing=overwrite_existing,
                                  all_in_gpu=all_in_gpu,
                                  step_size=step_size, checkpoint_name=checkpoint_name,
                                  segmentation_export_kwargs=segmentation_export_kwargs,
                                  disable_postprocessing=disable_postprocessing)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--do_gaussian_noise", required=False, type=int, default=0, help="add an extra gaussian nosie"
    ...
    tta = args.tta
    do_gaussian_noise = args.do_gaussian_noise
    ...
    #! 2021/06/05 Add TTA of making gaussian noise
    if do_gaussian_noise == 0:
        do_gaussian_noise = False
    elif do_gaussian_noise == 1:
        do_gaussian_noise = True
    else:
        raise ValueError("Unexpected value for do_gaussian_noise, Use 1 or 0")
    ...
    predict_from_folder(model, input_folder, output_folder, folds, save_npz, num_threads_preprocessing,
                        num_threads_nifti_save, lowres_segmentations, part_id, num_parts, tta,do_gaussian_noise,
