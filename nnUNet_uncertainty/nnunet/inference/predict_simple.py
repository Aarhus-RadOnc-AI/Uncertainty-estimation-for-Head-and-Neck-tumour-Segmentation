...
def main():
    ...
    parser.add_argument("--do_gaussian_noise", required=False, default=False, action="store_true",
                        help="add an extra gaussian noise map for test time data augmentation")
    ...
    if model == "3d_cascade_fullres" and lowres_segmentations is None:
        ...
        predict_from_folder(model_folder_name, input_folder, lowres_output_folder, folds, False,
                            num_threads_preprocessing, num_threads_nifti_save, None, part_id, num_parts, not disable_tta, do_gaussian_noise,
    ...
    predict_from_folder(model_folder_name, input_folder, output_folder, folds, save_npz, num_threads_preprocessing,
                        num_threads_nifti_save, lowres_segmentations, part_id, num_parts, not disable_tta, do_gaussian_noise,
                        overwrite_existing=overwrite_existing, mode=mode, overwrite_all_in_gpu=all_in_gpu,
                        mixed_precision=not args.disable_mixed_precision,
                        step_size=step_size, checkpoint_name=args.chk,num_mc_dropout=num_mc_dropout,
                        snapshots=snapshots)
    end = time()
